...
public class UniversalAttributesModMenu implements ModMenuApi {
    ...
    private Screen createConfigScreen(Screen parent) {
        ...
        addInternalsCategory(builder, eb, config.internals);
    ...
    private void addInternalsCategory(ConfigBuilder builder, ConfigEntryBuilder eb, Map<String, ModConfig.InternalRule> internals) {
        ConfigCategory category = builder.getOrCreateCategory(Text.translatable("text.universalattributes.section.internals"));
